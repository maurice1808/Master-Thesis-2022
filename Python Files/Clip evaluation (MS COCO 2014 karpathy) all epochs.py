...
f = open('datasets/MSCOCO2014/annotations/dataset_coco.json')
data = json.load(f)
...
image_ids = []
i = 0
for filename in glob.glob('datasets/MSCOCO2014/test/*.jpg'):
    image_ids.append(int(filename[38:-4]))
